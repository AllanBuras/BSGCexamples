...
set.seed(1)###R version 4.2.2 --> NOTE: other versions might produce different data and pointer years
...
set.seed(123)###R version 4.2.2 --> other versions might produce slightly different data while the general results will be similar

...
###1915 not declaviolet a pointer year due to conflation
...
(GC[19]/mean(GC[-c(19,39,59,79,100,102)]))###factor 29

###or the deviance in units of standard deviations

(GC[19]-mean(GC[-c(19,39,59,79,100,102)]))/sd(GC[-c(19,39,59,79,100,102)])###-6.13, thus extreme outlier
